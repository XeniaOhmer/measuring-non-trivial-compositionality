...
cat_1 = ['color_' + str(i) for i in range(7, 19)]
for i in range(5):
...
# for k, key in enumerate(TC.keys()):
#     if k % 25 == 0:
#         print(k, key, TC[key], diagonal[key], mixed_protocols[2][key])
...
df.to_csv('results/results_experiment_4.csv')
...
with sns.plotting_context('paper', font_scale=1.1, rc={"lines.linewidth": 2.5}):
    ...
    p.savefig('results/figure_experiment_4.png', dpi=300)
